...
DEST_DIR = "bgm_library_large"         # folder for mp3s
OUT_CSV = "audio_features_large.csv"   # metadata + features
REQUEST_DELAY = 0.5              # seconds between HTTP requests
MAX_PER_CATEGORY = 20             # 🔹 Target: Get 6 SUCCESSFUL tracks per category
